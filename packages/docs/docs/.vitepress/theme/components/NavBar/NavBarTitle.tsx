...
const NavBarTitle = defineComponent({
    ...
    setup(){
        const { theme } = useData()
        return ()=>(
                <a href="/" class="home-link" style={{position:"absolute",left: "0",fontWeight:"bolder",paddingLeft: "30px"}}>
                    <svg class="logo-nav" style={{ fill: "var(--vs-theme-color)",height: "28px"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 401.69 98.4">
                    ...
                    {theme.value.logo &&<img v-if="theme.logo" class="logo" src={theme.value.logo }/>}
