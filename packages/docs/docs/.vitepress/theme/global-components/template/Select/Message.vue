<template>
    <div class="center">
        <VsSelect v-model="value" placeholder="Success" color="success" class="select">
        ...
        <VsSelect v-model="value2" placeholder="LabelPlaceholder" class="select">
        ...
        <VsSelect v-model="value3" placeholder="Placeholder" class="select">
