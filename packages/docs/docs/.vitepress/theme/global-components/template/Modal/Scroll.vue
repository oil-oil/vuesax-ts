<template>
  <div class="center">
    <VsButton shadow @click="active = !active"> Open Dialog </VsButton>
    <VsModal scroll lockScroll :showClose="false" auto-width v-model="active">
      <template #header>
        <h3>Introduction</h3>
      </template>
...
import { ref } from 'vue'
import { VsModal, VsButton } from 'vuesax-ts'
